...
@section('title')Amyal l Employee @endsection
@section('css')
    <style>
        ol {list-style:none}
    </style>
...
@section('content')
    <nav id="breadcrumb" class="breadcrumb">
        <a href="#" class="breadcrumb-link">Amyal Employee</a>
    ...
    <div class="orders-table">
        <div class="table-responsive text-center">
            <h2 class="orang1 text-left" style="margin-bottom:10px; ">My Permissions</h2>
