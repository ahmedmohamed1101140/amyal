...
@section('title')Amyal l Pickup Agent @endsection
@section('content')
    <nav id="breadcrumb" class="breadcrumb">
        <a href="#" class="breadcrumb-link">Pickup Agent</a>
    ...
    <div class="orders-table">
        <div class="table-responsive text-center">
            <h2 class="orang1 text-left" style="margin-bottom:10px; ">{{$agent->name}} pick up requests</h2>
            <table class="table main-table">
                ...
                @foreach($requests as $request)
                    <tr>
                        ...
                        <td>{{$request->status == 'Assign To' ? 'Agent Take on action on this request' : $request->status}}</td>
                    </tr>
                @endforeach
                </tbody>
            </table>
